          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: SvgPicture.asset(IconsPath.personIcon, height: 18.sp,),
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
              ...
              Container(
                ...
                child: SvgPicture.asset(IconsPath.groupIcon, height: 18.sp,),
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
              ...
              Container(
                ...
                child: SvgPicture.asset(IconsPath.msgIcon, height: 18.sp,),
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
